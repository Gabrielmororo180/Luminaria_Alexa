...
std::vector<RelayInfo> relays = {
    {"62913c82c67e23532c8e21bb", "Led1", 0},
    {"62913ca0c67e23532c8e21ee", "Led2", 1},
    {"62913cb2ff3682115432b3bf", "Led3", 2},};
/*   ^^^^^^^^^^^^^^^^^^^^^^^^^   ^^^^^^^^^  ^^^
 *              |                     |      |
...
#define WIFI_PASS  "eu1234567"
/*Credenciais Siniric Pro*/
#define APP_KEY    "ererddfefe17e6f-3e0eee5-437d-b805-6d87aa1abd5d"    // Should look like "de0bxxxx-1x3x-4x3x-ax2x-5dabxxxxxxxx"
#define APP_SECRET "7666601da946-ce2fdddd-4246-afcf-ac15e09be6e4-0fbb2e9d-e6aa-405f-819f-c7f5523f8ec1" // Should look like "5f36xxxx-x3x7-4x3x-xexe-e86724a9xxxx-4c4axxxx-3x3x-x5xe-x9x3-333d65xxxxxx"
